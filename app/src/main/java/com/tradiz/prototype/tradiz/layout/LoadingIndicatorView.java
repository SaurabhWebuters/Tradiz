...
public class LoadingIndicatorView extends View {
    ...
    private static final PulseIndicator DEFAULT_INDICATOR=new PulseIndicator();
    ...
    private void init(Context context,AttributeSet attrs,int defStyleAttr, int defStyleRes) {
        ...
        mIndicatorColor=a.getColor(R.styleable.LoadingIndicatorView_indicatorColor, Color.parseColor("#fab11e"));   // Setting Loading Indicator color yellow
